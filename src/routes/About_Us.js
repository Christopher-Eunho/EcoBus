...
const About_Us = () => <main>
    ...
    <section>
        ...
        <p>
            ...
            He joined the CST program to work on projects and learn how to automate tasks so he can enjoy the simple things in life. Austin is excited to see what new technologies will be developed in the future to combat the global climate crisis.
        </p>
    </section>
    <section>
        ...
        <p>
            Dylan is a student who recently graduated from high school. After taking a semester off to save money, he applied to CIT, before changing his mind, and applying to CST the following term.
            He has always been interested in the world of computers, rebuilding his own countless times, and originally joined CST with the intent of becoming a game developer. Now, he wants to use his programming skills to benefit the world however he can.
        </p>
    </section>
</main>;
