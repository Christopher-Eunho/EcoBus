...
export function OriginSearch({ 
    ...
    /**
     * Set default origin input value as 'Current Location'.
     */
    useEffect(() => {
    ...
    /**
     * Change origin input value to the user's input.
     */
    ...
    /**
     * Handle when user selects one of the places generated by location autocomplete.  
     */
